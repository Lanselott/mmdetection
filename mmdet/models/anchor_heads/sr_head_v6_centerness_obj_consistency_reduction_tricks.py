...
from mmdet.core import multi_apply, multiclass_nms, multiclass_nms_test, multiclass_nms_sorting, distance2bbox, bbox2delta, bbox_overlaps
...
class SRHeadV6CenternessObjConsistencyReductionTricks(nn.Module):
    ...
    def __init__(self,
        ...
        super(SRHeadV6CenternessObjConsistencyReductionTricks, self).__init__()
    ...
    def forward_single(self, x, scale):
        ...
        bd_scores_pred = self.fcos_bd_scores(cls_feat)
