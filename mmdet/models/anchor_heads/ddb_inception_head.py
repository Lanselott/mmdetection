...
from mmdet.core import multi_apply, multiclass_nms, multiclass_nms_test, multiclass_nms_sorting, distance2bbox, bbox_overlaps
...
class DDBInceptionHead(nn.Module):
    ...
    def get_bboxes_single(self,
        ...
        det_bboxes, det_labels = multiclass_nms_sorting(
            ...
            mlvl_bd_scores,
            cfg.score_thr,
            dict(type='nms_v2', iou_thr=0.5, c_thr=0.98),# cfg.nms,
            cfg.max_per_img,
