...
class BoxCodingIoUCoordRegHead(nn.Module):
    """
    ...
    def __init__(self,
        ...
        super(BoxCodingIoUCoordRegHead, self).__init__()
    ...
    def loss(self,
        ...
        if num_pos > 0:
            ...
            for i in range(self.bit_nums):
                ...
                '''
                pos_bbox_bit_pred = dsntnn.flat_softmax(pos_bbox_bit_preds[i].reshape(-1, 1, 1, 10))
                pos_bbox_bit_coords_pred = (dsntnn.dsnt(pos_bbox_bit_pred)[..., 0] + 0.9) / 0.2
