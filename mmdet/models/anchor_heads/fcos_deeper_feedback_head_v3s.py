...
from ..utils import ConvModule, ConvTransModule, Scale, bias_init_with_prob
...
class FCOSDeeperFeedbackHeadV3S(nn.Module):
    """
    ...
    def __init__(self,
        ...
        super(FCOSDeeperFeedbackHeadV3S, self).__init__()
    ...
    def foward_feedback(self, cls_feat_residual, reg_feat_residual, x, scale):
        '''
