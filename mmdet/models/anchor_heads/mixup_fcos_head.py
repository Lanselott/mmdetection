...
class MixupFCOSHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(MixupFCOSHead, self).__init__()
    ...
    def loss(self,
        ...
        loss_cls_max = self.loss_cls(
            flatten_cls_scores, flatten_max_labels,
            avg_factor=num_pos + num_imgs)  # avoid num_pos is 0
